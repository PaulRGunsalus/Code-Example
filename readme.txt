...
the terms of careers. Mega-Contracts are something worht exploring if players are just being compensated for previous work.
...
For files for cleaning code are included. Open file "Official Shiny.R" and run the code, everything should run accordingly.
...
and DPB(Dollars per Base)
(Salary(Adjusted)/total_bases)
