...
CPI(Consumer Price Index) information http://research.stlouisfed.org/fred2/data/CPIAUCSL.txt

Files for data cleaning are included see Cleaned Code.R.
Open file "Official Shiny.R" and run the code, everything should run accordingly.
